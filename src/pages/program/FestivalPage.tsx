...
import GnfestaSections from '@/components/gnfesta/GnfestaSections'
...
export default function FestivalPage({ slug }: Props) {
  ...
  return (
    <div className={styles.page} style={themeStyle}>
      ...
      />
      {slug === 'gnfesta' ? (
        // gnfesta: 포스터 없이 우아한 따옴표 인용 블록 — 메인 포스터와 동일하므로 중복 제거
      ...
      {slug === 'gnfesta' && <GnfestaSections festivalId={festival.id} />}
